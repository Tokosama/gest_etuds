             ...
             <div class="bg-yellow-500 text-white shadow-lg rounded-xl overflow-hidden hover:shadow-2xl transform hover:scale-105 transition">
                <div class="p-8">
                    ...
                    <a href="{{ route('notes.index') }}" 
                      ...
                      <!-- Card Bulletins -->
                      <div class="bg-gradient-to-br from-red-500 to-red-700 text-white shadow-lg rounded-xl overflow-hidden hover:shadow-2xl transform hover:scale-105 transition">
                <div class="p-8">
                    <h2 class="text-3xl font-bold text-white mb-4">Bulletins</h2>
                    <p class="text-white/90 mb-6">Consultez les bulletins des étudiants.</p>
                    <a href="{{ route('bulletins.index') }}" 
                       class="inline-block bg-white text-red-700 font-medium py-2 px-4 rounded hover:bg-red-800 transition">
                       Voir les Bulletins
                    </a>
                </div>
            </div>
